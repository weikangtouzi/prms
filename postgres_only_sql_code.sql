...
BEGIN
  INSERT INTO public.job_cache(
	job_id, title, category, address_coordinate, address_description, min_salary, max_salary, min_experience, min_education, ontop, full_time_job, tags, expired_at, updated_at, hr_name, hr_pos, comp_name, comp_size, comp_financing, logo) 
